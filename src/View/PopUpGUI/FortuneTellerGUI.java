...
public class FortuneTellerGUI extends JPanel {
    ...
    /**
     * Method checks if the fortune is a blessing or a curse and changes the View.GUI accordingly before it calls the method startGUI().
