...
public class GameHistoryLog {
    ...
    public void logDiceRollEvent(Player player, Tile landingTile, int sumRoll) {
        ...
        gameHistoryPanel.append(String.format("<font color=%s><b>%s</b></font> rolled a combined <b>%d</b>, landing on <font color=%s><b>%s</b></font>.",
                playerColorHex, playerName, sumRoll, landingTileColorHex, landingTileName));
    }
    ...
    public void logDoubleDiceRollEvent(Player player, Tile landingTile, int doubleRoll) {
        ...
        String landingTileName = landingTile.getName();
        gameHistoryPanel.append(String.format("<font color=%s><b>%s</b></font> rolled a combined <b>%d</b>, landing on <font color=%s><b>%s</b></font>.",
                playerColorHex, playerName, doubleRoll, landingTileColorHex, landingTileName));
    }

    public void logWorkEvent(Player player, int payAmount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s earned %s working.", htmlFormatPlayerName(playerName, playerColorHex),
                htmlFormatGoldCoins(payAmount)));
    }

    public void logTaxEvent(Player player, int taxAmount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s got taxed %s.", htmlFormatPlayerName(playerName, playerColorHex),
                htmlFormatGoldCoins(taxAmount)));
    }

    public void logTaxPayoutEvent(Player player, int taxPayoutAmount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s collected %s from the Church.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(taxPayoutAmount)));
    }

    public void logPassGoEvent(Player player, int payoutAmount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s passed go and received %s.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(payoutAmount)));
    }
    ...
    public void logPropertyBuyEvent(Player player, Property propertyTile) {
        ...
        gameHistoryPanel.append(String.format("%s purchased %s for %s.", htmlFormatPlayerName(playerName, playerColorHex),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatGoldCoins(propertyTilePrice)));
    }
    ...
    public void logPropertySellEvent(Player player, Property propertyTile) {
        ...
        String propertyTileName = propertyTile.getName();
        int propertyTilePrice = propertyTile.getPrice();
        gameHistoryPanel.append(String.format("%s sold %s for %s.", htmlFormatPlayerName(playerName, playerColorHex),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatGoldCoins(propertyTilePrice)));
    }
    ...
    public void logPropertyRentEvent(Player player, Property propertyTile) {
        ...
        gameHistoryPanel.append(String.format("%s visited %s's %s and had to pay %s in rent.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatPlayerName(propertyOwnerName, propertyOwnerColorHex),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatGoldCoins(propertyTileRent)));
    }
    ...
    public void logPropertyUpgradeEvent(Player player, Property propertyTile) {
        ...
        gameHistoryPanel.append(String.format("%s upgraded %s to level %s, for %s.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatTileName(propertyTileName, propertyTileColorHex),
                propertyTileLevel, htmlFormatGoldCoins(propertyTileUpgradePrice)));
    }
    ...
    public void logPropertyDownGradeEvent(Player player, Property propertyTile) {
        ...
        gameHistoryPanel.append(String.format("%s downgraded %s to level %s, recouping %s.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatTileName(propertyTileName, propertyTileColorHex),
                propertyTileLevel, htmlFormatGoldCoins(propertyTileUpgradePrice)));
    }
    ...
    public void logTavernRentEvent(Player player, Tavern propertyTile, int randomValue) {
        ...
        gameHistoryPanel.append(String.format("%s visited %s's %s and had to pay %s in rent.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatPlayerName(propertyOwnerName, propertyOwnerColorHex),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatGoldCoins(randomValue)));
    }
    ...
    public void logPlayerRankUpEvent(Player player) {
        ...
        gameHistoryPanel.append(String.format("%s ranked up! Reaching the rank %s!",
                htmlFormatPlayerName(playerName, playerColorHex), playerRank));
    }
    ...
    public void logPlayerRankDownEvent(Player player) {
        ...
        String playerName = player.getName();
        String playerRank = player.getPlayerRank().name();
        gameHistoryPanel.append(String.format("%1$s ranked down! %1$s is now a %2$s.",
                htmlFormatPlayerName(playerName, playerColorHex), playerRank));
    }
    ...
    public void logPlayerEliminatedEvent(Player player) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s has been eliminated from the game!",
                htmlFormatPlayerName(playerName, playerColorHex)));
    }
    ...
    public void logJailEnterEvent(Player player) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s has been jailed for their crimes!",
                htmlFormatPlayerName(playerName, playerColorHex)));
    }
    ...
    public void logJailExitEvent(Player player) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s has been released from jail.",
                htmlFormatPlayerName(playerName, playerColorHex)));
    }
    ...
    public void logJailExitCostEvent(Player player, int totalBail) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s has been released from jail after paying %s.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(totalBail)));
    }

    public void logJailStayEvent(Player player) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%1$s stayed the round in jail. %1$s has been in jail for %2$s rounds.",
                htmlFormatPlayerName(playerName, playerColorHex), player.getJailCounter()));
    }

    public void logFortuneBlessingEvent(Player player, int income) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s collected %s from fortune teller",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(income)));
    }

    public void logFortuneCurseEvent(Player player, int amount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s lost %s from fortune teller",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(amount)));
    }

    public void logDuelWinner(Player player, int income) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s won a duel and earned %s",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(income)));
    }
    ...
    public void logDuelLoser(Player player, int amount) {
        String playerColorHex = Utils.colorToHexString(player.getPlayerColor());
        String playerName = player.getName();
        gameHistoryPanel.append(String.format("%s lost a duel and lost %s",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatGoldCoins(amount)));
    }
    ...
    public void logTradeEventGold(Player activePlayer, Player otherPlayer, Property propertyTile, int offer){
        ...
        String propertyTileColorHex = Utils.colorToHexString(propertyTile.getColor());
        String propertyTileName = propertyTile.getName();
        gameHistoryPanel.append(String.format("%1$s completed a trade with %2$s. %1$s has purchased %3$s from %2$s for %4$s",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatPlayerName(playerName2, playerColorHex2),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatGoldCoins(offer)));
    }
    ...
    public void logTradeEventProperty(Player activePlayer, Player otherPlayer, Property propertyTile, Property propertyTile2){
        ...
        gameHistoryPanel.append(String.format("%1$s completed a trade with %2$s. %1$s traded away %3$s to %2$s and received %4$s in return.",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatPlayerName(playerName2, playerColorHex2),
                htmlFormatTileName(propertyTileName, propertyTileColorHex),
                htmlFormatTileName(propertyTileName2, propertyTileColorHex2)));
    }
    ...
    public void logTradeEventGoldAndProperty(Player activePlayer, Player otherPlayer, Property propertyTile, Property propertyTile2, int offer) {
        ...
        String propertyTileName = propertyTile.getName();
        String propertyTileName2 = propertyTile2.getName();
        gameHistoryPanel.append(String.format("%1$s completed a trade with %2$s. %1$s traded away %3$s and %5$s to %2$s and received %4$s in return",
                htmlFormatPlayerName(playerName, playerColorHex), htmlFormatPlayerName(playerName2, playerColorHex2),
                htmlFormatTileName(propertyTileName, propertyTileColorHex), htmlFormatTileName(propertyTileName2, propertyTileColorHex2),
                htmlFormatGoldCoins(offer)));
    }
